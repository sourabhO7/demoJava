...
public class GloLogisticsWebRowSetXmlDelete {
    public static void main(String[] args) {
        ...
        try{
            ...
            // modify the tag in the xml file and update it as deleteRow
            rowSet.moveToCurrentRow();
            rowSet.acceptChanges();

            System.out.println("Suppier data stored in the database deleted successfully!....");
